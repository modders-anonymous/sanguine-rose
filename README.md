...
- 1️⃣*SanguineRose* considers *all* mod sites as first-class citizens. In other words, if your mod is on LL or anywhere else, your mod will get the same treatment as mods from Nexus. Including screenshots, links to your Patreon/Discord, endorsements, and so on. 
